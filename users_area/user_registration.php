            ...
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4">
                     ...
                     <input type="email"id="user_email" class="form-control" placeholder="Enter your email id" autocomplete="off" required="required" name="user_email"/>
                    </div>
                    <!-- image field -->
                    <div class="form-outline mb-4">
                    ...
                    <div class="form-outline mb-4">
                     ...
                     <input type="password"id="conf_user_password" class="form-control" placeholder="Re-enter Password" autocomplete="off" required="required" name="conf_user_password"/>
                    </div>
                    <!-- Address field -->
                    <div class="form-outline mb-4">
